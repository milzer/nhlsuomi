...
class Test_icydata(unittest.TestCase):
    ...
    def test_hilights(self):
        ...
        hilights, _ = icydata.parse_hilights_recaps(
            self.submissions,
            keywords,
            18,
        ...
        expected = [
            (
                'Laine scores goal',
                'https://wscdsszoominwestus.azureedge.net/publish/d663e54d-db5e-4c7d-b3d8-9a0b548aebd4.mp4',
            ),
            (
                'Korpisalo makes save',
                'https://wscdsszoominwestus.azureedge.net/publish/6efb1f8b-0e2d-498a-aaae-839980d3139c.mp4',
            ),
            (
                'Ristolainen scores PPG',
                'https://wscdsszoominwestus.azureedge.net/publish/4a64f0f7-c9cf-4e2c-acef-57439a4bcd71.mp4',
            )
        ]
    ...
    def test_recaps(self):
        ...
        _, recaps = icydata.parse_hilights_recaps(
            self.submissions[:2], [], 18
        )
